...
class Injection extends StatelessWidget {
  ...
  static List url = [
    'medimage/injbrexin.png',
    'medimage/injneurobion.png',
    'medimage/injoxidil.png',
    'medimage/injphlogin.png',
    'medimage/injvelosef.png',
    'medimage/injvenofer.png'
  ];
  static List desc = [
