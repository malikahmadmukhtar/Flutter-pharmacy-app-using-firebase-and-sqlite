...
class Syrups extends StatelessWidget {
  Syrups({super.key});
  ...
  static List url = [
    'medimage/syparinac.png',
    'medimage/syparinac.png',
    'medimage/sypbrufen.png',
    'medimage/sypcalpol.png',
    'medimage/sypcosome.png',
    'medimage/syppulmonol.png'
  ];
  static List desc = [
